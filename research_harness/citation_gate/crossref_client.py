...
# see LICENSE in this directory. Original module: scripts/crossref_client.py
...
class CrossrefClient:
    ...
    def doi_lookup_with_title_check(
        ...
        if not title.strip():
            # Upstream record carries an EMPTY title (e.g. some ACL
            # Anthology deposits): the DOI resolved — an impossible
