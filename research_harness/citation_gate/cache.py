...
# see LICENSE in this directory. Original module: scripts/verification_cache.py
...
_DEFAULT_PATH = Path.home() / ".cache" / "research_harness" / "citation_gate.db"
_ENV_PATH = "RH_CITATION_CACHE_PATH"
