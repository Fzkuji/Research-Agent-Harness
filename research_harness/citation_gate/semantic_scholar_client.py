...
# see LICENSE in this directory. Original module: scripts/semantic_scholar_client.py
...
class SemanticScholarUnavailable(Exception):
    ...
    Moved here from ARS scripts/contamination_signals.py so the client is
    self-contained; semantics unchanged (absence != negative confirmation).
    """
